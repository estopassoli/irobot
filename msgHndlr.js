...
module.exports = msgHandler = async (client, message) => {
    try {
        ...
        const mess = {
            wait: 'Espere, estamos processando seu pedido.',
            error: {
                St: '*Envie* uma imagem com comando *!sticker* ou marque uma imagem e cite o comando',
                Qm: 'Ocorreu um erro, tente novamente',
                Yt3: 'Ocorreu um erro, não foi possível converter para mp3!',
                Yt4: 'Ocorreu um erro, não foi possível converter para mp4.',
                Ig: 'Ocorreu um erro, talvez porque a conta é privada',
                Ki: 'Bots não podem remover administradores de grupo!',
                Ad: 'Não é possível adicionar o destino, talvez porque seja privado',
                Iv: 'O link inserido não é válido !'
            }
        }
